    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            array(
                ...
                'name' => 'blog_title',
                'type' => 'text',
                'default_value' => '<span class="font-italic">Cẩm nang</span> Mẹ & Bé',
            ),
            array(
                ...
                'type' => 'textarea',
                'default_value' => 'Chia sẻ những kiến thức hữu ích về chăm sóc mẹ sau sinh, dịch vụ tắm bé sơ sinh và kinh nghiệm nuôi con khoa học.',
            ),
            array(
            ...
            array(
                ...
                'name' => 'cta_1_title',
                'type' => 'text',
                'default_value' => 'Dịch vụ <em class="font-italic">Tắm bé</em><br />sơ sinh',
            ),
            array(
            ...
            array(
                ...
                'name' => 'cta_2_title',
                'type' => 'text',
                'default_value' => 'Chăm sóc <em class="font-italic">Mẹ sau sinh</em>',
            ),
            array(
            ...
            array(
                ...
                'name' => 'cta_3_title',
                'type' => 'text',
                'default_value' => 'Thông tắc <em class="font-italic">Tia sữa</em>',
            ),
            array(
                ...
                'name' => 'cta_3_link',
                'type' => 'text',
                'default_value' => '/thong-tac-tia-sua',
            ),
            array(
            ...
            array(
                ...
                'name' => 'footer_email',
                'type' => 'text',
                'default_value' => 'cskh@homegroups.vn',
            ),
            array(
                ...
                'name' => 'footer_address',
                'type' => 'textarea',
                'default_value' => '20 Huy Du, Phường Từ Liêm, TP Hà Nội, Việt Nam.',
            ),
            array(
                ...
                'type' => 'url',
                'default_value' => 'https://www.facebook.com/homecare',
            ),
            array(
                ...
                'type' => 'url',
                'default_value' => 'https://instagram.com/homecare',
            ),
            array(
                ...
                'type' => 'url',
                'default_value' => 'https://www.linkedin.com/company/homecare',
            ),
            array(
