...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-332PZCQERN"></script>
    <script>
                ...
                <ul class="menu">
                    ...
                    <li class="!hidden mobile:!inline-block">
                        <a href="tel:<?php echo esc_attr($header_phone_clean); ?>" class="" aria-label="Call us">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/icons/phone-dark.svg" width="20" height="20" alt="phone icon" class="w-5 relative -top-[1px]" />
                        </a>
                    </li>
                </ul>
            </div>
